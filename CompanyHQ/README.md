...
## Studio-grade expansion

- Added specialist agent packs for design, art, audio, backend, mobile, data, security, production, liveops, localization, community, and support under `agents/`.
- Added deep Unity and React capability libraries including genre playbooks, networking/fullstack, refactoring, release readiness, and subagent models.
- Added `resources/` knowledge base with operating model, production, quality, security, telemetry, and document templates to support top-tier studio workflows.
